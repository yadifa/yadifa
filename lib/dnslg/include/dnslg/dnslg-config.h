/* include/dnslg/dnslg-config.h.  Generated from dnslg-config.h.in by configure.  */
/* include/dnslg/dnslg-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Name of package */
#define PACKAGE "dnslg"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "bugreport@yadifa.eu"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dnslg"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dnslg 2.0.4-4585"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dnslg"
